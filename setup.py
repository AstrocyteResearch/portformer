...
setuptools.setup(
    name="portformer", # Replace with your own username
    version="0.1.0",
    author="Sean Kruzel",
    author_email="skruzel@portformer.com",
    description="Portfolios. Built Better",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/AstrocyteResearch/portformer",
